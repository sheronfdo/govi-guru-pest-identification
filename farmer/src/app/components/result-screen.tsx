...
export function ResultScreen({ pestType, onBack, onAskExpert }: ResultScreenProps) {
  ...
  const pestData = {
    'brown-plant-hopper': {
      ...
      traditional: [
        'Use light traps in the evening to attract and catch hoppers',
        'Apply neem oil spray (5ml per liter of water) every 7 days',
        'Release natural predators like spiders and dragonflies in the field',
      ],
      chemical: [
        'Imidacloprid 17.8% SL - 0.5ml per liter of water',
        'Thiamethoxam 25% WG - 0.2g per liter of water',
        'Apply early morning or late evening, avoid midday application',
      ],
    },
    'rice-bug': {
      name: 'Rice Bug',
      ...
      traditional: [
        'Hand-pick bugs during early morning when they are less active',
        'Use pheromone traps to catch adult bugs',
        'Spray garlic-chili solution (100g crushed garlic + 50g chili powder per 10L water)',
      ],
      chemical: [
        'Cypermethrin 10% EC - 1ml per liter of water',
        'Chlorpyrifos 20% EC - 2ml per liter of water',
        'Spray when bugs are in the milking stage of paddy',
      ],
    },
  };

  const pest = pestData[pestType as keyof typeof pestData] || pestData['brown-plant-hopper'];
      ...
      <div className="flex-1 overflow-y-auto pb-6">
        ...
        <div className="px-6 py-6">
          <div className="bg-white rounded-xl overflow-hidden shadow-lg">
            <ImageWithFallback
              src="https://images.unsplash.com/photo-1651131381902-f34030f4a2d4?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxpbnNlY3QlMjBwZXN0JTIwZGFtYWdlJTIwcmljZSUyMHBsYW50fGVufDF8fHx8MTc3MDQ5ODQ0OXww&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
              alt={pest.name}
        ...
        <div className="px-6 mb-6">
          <div className="bg-white rounded-xl p-5 shadow-md flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-bold" style={{ color: '#333' }}>{pest.name}</h3>
              <p className="text-sm italic" style={{ color: '#666' }}>{pest.scientificName}</p>
        ...
        <div className="px-6">
          <div className="bg-white rounded-xl p-5 shadow-md">
            ...
            <ul className="space-y-4">
              {(activeTab === 'traditional' ? pest.traditional : pest.chemical).map((solution, index) => (
